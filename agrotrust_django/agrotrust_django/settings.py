"""
Django settings for agrotrust_django project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-gwp8$a!#1a3%gn^&3f&7@0y8q3gtwei#t&23&g7#e4(*n1=5uw')
...
WSGI_APPLICATION = 'agrotrust_django.wsgi.application'
...
# Security settings for third-party iframe cookie support on Hugging Face
